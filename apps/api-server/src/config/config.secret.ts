...
export const QINIU_ACCESSKEY = "0tkChECfIkhsuIhXpzOtAF8YUrS_RjrIU_ek09Ii"; // 七牛云秘钥AK
export const QINIU_SECRETKEY = "dumc9QRnaJI8Ip72wlb27OR-in_4JbkrjjtBo1kp"; // 七牛云秘钥SK
...
export const GAODE_WEB_IP_KEY = "fbb0e73c5bd4d46f4743270f8c965cfb"; // 高德地图key

export const QQ_EMAIL_USER = "1871321876@qq.com"; // qq邮箱auth的用户
export const QQ_EMAIL_PASS = "cfjrtflysvevdbhc"; // qq邮箱auth的秘钥
