...
const dirLang = resolve(__dirname,'..','..','src/logger/lang');
...
/**
	...
	trace(where, what, ...rest) { this.logger.trace('',...arguments); }
	/**
	  * 调试（debug）
	  ...
	  */
	// eslint-disable-next-line no-unused-vars
	debug(where, what, ...rest) { this.logger.debug('',...arguments); }
	/**
	 * 信息（info）
	 ...
	 * @param {any[]} infos 日志内容。第一个内容不换行，第二个内容开始换行并缩进
	 */
	info(where, what, ...rest) { this.logger.info('',...arguments); }
	/**
	 * 警告（warn）
	 * - 用于`有可能`导致异常的运行记录
	 ...
	 * @param {any[]} infos 日志内容。第一个内容不换行，第二个内容开始换行并缩进
	 */
	warn(where, what, ...rest) { this.logger.warn('',...arguments); }
	/**
	 * 错误（error）
	 * - 用于`异常`逻辑、`错误`数据的运行记录
	 ...
	 */
	// eslint-disable-next-line no-unused-vars
	error(where, what, ...rest) { this.logger.error('',...arguments); }
	/**
	 * 致命（fatal）
	 ...
	 */
	// eslint-disable-next-line no-unused-vars
	fatal(where, what, ...rest) { this.logger.fatal('',...arguments); }
	/**
	 * 标记（mark）
	 ...
	 */
	// eslint-disable-next-line no-unused-vars
	mark(where, what, ...rest) { this.logger.mark('',...arguments); }
