...
import Wocker from './lib/Wock';
import initMounterFold from './lib/mounter/http-fold';
import initMounterFace from './lib/mounter/http-face';
import initMounterFaceWock from './lib/mounter/wock-face';
 ...
 */
async function ServerDefaultHarb($_) {
	const $ = $_;
	...
	// 挂载HTTP接口
	const router: any = $.router = new KoaRouter();
...
export default ServerDefaultHarb;